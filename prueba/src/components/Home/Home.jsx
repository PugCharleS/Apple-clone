import { Banner, NewBanner, MacBanner } from '../Banner/Banner';
...
export const Home = () => {
  return (
    <>
      ...
      <MacBanner title="MacBook Pro" subtitle="Todo el poder para los Pro." img="https://www.apple.com/v/macbook-pro-14-and-16/b/images/meta/macbook-pro-14-and-16_overview__fz0lron5xyuu_og.png"/>
    </>
  )
}
